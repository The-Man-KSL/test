...
Config.Stores = {
    ...
    {
        type = "clothing",
        coords = vector4(-300.9306, -2001.6663, 30.0003, 74.3916),
        size = vector3(4, 4, 4),
        rotation = 45,
        showBlip = false,
        usePoly = false,
    ...
    {
        type = "clothing",
        coords = vector4(-348.9814, -2006.2366, 29.9918, 315.2091),
        size = vector3(4, 4, 4),
        rotation = 45,
        showBlip = false,
        usePoly = false,
    ...
    {
        type = "clothing",
        coords = vector4(-367.6901, -1993.5337, 29.9803, 145.8592),
        size = vector3(4, 4, 4),
        rotation = 45,
        showBlip = false,
        usePoly = false,
    ...
    {
        type = "clothing",
        coords = vector4(-365.1193, -1970.2203, 29.9738, 140.0332),
        size = vector3(4, 4, 4),
        rotation = 45,
        showBlip = false, 
        usePoly = false,
    ...
    {
        type = "clothing",
        coords = vector4(4489.6895, -4452.8213, 4.3635, 44.9161),
        size = vector3(4, 4, 4),
        rotation = 45,
        showBlip = false, 
        usePoly = false,
    ...
    {
        type = "surgeon",
        coords = vector4(-1833.5471, -341.5546, 49.4627, 238.1399),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
...
Config.ClothingRooms = {
    {
        job = "police",
        coords = vector4(458.2949, -999.0488, 30.6895, 15.9460),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "police",
        coords = vector4(3650.0676, 5718.3652, 6.3033, 51.2745),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
         points = {
