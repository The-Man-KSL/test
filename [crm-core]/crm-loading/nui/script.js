const serverIp = "14.102.233.188:30120"



let currentTrack = 0
$(document).ready(function () {
    $.post(`http://${serverIp}/crm-loading/getConfig`, {},
    ...
    setTimeout(() => {
        $.post(`http://${serverIp}/crm-loading/getPlayers`, {},
        function (data, textStatus, jqXHR) {
            if (data) {
                data = JSON.parse(data)
    ...
    $.post(`http://${serverIp}/crm-loading/getInfo`, {},
        function (data, textStatus, jqXHR) {
            if (data) {
                data = JSON.parse(data)
