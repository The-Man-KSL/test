...
function updateCash()
    ...
    ESX.TriggerServerCallback('esx_mechanic:getCurrentMoney', function(amount)
        currentMoney = amount
                    ...
                    elseif (menuOption.price > 0) then
                        ...
                        if (getCurrentMoney() >= tempPrice) then
                            ...
                            if (tempPrice > 0 or Config.AutoSaveVehiclePropertiesOnApply == true) then
                                ...
                                TriggerServerEvent('esx_mechanic:removeMoney', tempPrice, isWhitelistJob, customConfigPosIndex, vehiclePorperties)
                            end
                        end
                    end
                end
