(function(){
	...
	let MenuTpl = `
		<div id="menu_{{_namespace}}_{{_name}}" class="dialog {{#isBig}}big{{/isBig}}">
			<div class="head"><span>{{title}}</span></div>
				...
				<div class="buttons">
					<button type="button" name="submit"><i class="fas fa-check-circle"></i></button>
					<button type="button" name="cancel"><i class="fas fa-times-circle"></i></button>
				</div>
			</div>
		</div>
	`
	...
	window.ESX_MENU       = {};
	ESX_MENU.ResourceName = 'crm-dialog';
	ESX_MENU.opened       = {};
	ESX_MENU.focus        = [];
	ESX_MENU.pos          = {};
