...
$(document).keyup(function(e) {
    if (e.keyCode === 27) {
        ...
        $.post('https://crm-multijob/close', JSON.stringify({}));
...
window.addEventListener('message', function(event) {
    ...
    $(".select").click(function() {
        ...
        if ($(this).hasClass('offduty')) {
            ...
            if (offduty) {
                ...
                $.post('https://crm-multijob/changejob', JSON.stringify({
                    job: this.dataset.job,
                    grade: this.dataset.grade
                }));
            } else {
                $.post('https://crm-multijob/cantoffduty', JSON.stringify({}));
            }
        } else {
            $(document).find(".select").text('SELECT');
            $(this).text('SELECTED');
    ...
    $(".removebutton").click(function() {
        ...
        $.post('https://crm-multijob/removejob', JSON.stringify({
            job: this.dataset.job,
            grade: this.dataset.grade
        }));
    });
