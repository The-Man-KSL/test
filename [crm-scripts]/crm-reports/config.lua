...
Config.AdminList = {
	'steam:11000010b36484d', -- Example, change this
...
Config.BotName = 'CRMRP' -- Write the desired bot name

Config.ServerName = 'CRMRP' -- Write your server's name

Config.IconURL = 'https://cdn.discordapp.com/attachments/898285230421573663/1155534486054904009/PFP_V2_-_CRM_Development.png' -- Insert your desired image link
