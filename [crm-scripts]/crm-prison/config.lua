...
Config.Prisons = {
    ["default"] = { -- Default is used as the prison location for players when not defined otherwise.
        ...
        activities = {
            {
                ...
                coords = vector3(1746.8618, 2484.8970, 12.6100),
                heading = 27.7556,
        ...
        cells = {
            {
                coords = vector3(1699.2325, 2443.0391, 45.8397), -- Location of the cell.
                heading = 0.2770, -- Direction to face the player upon spawn.
                size = 1.5, -- Size to check to see if any players are inside the cell.
            },
            {
                coords = vector3(1696.0343, 2443.1033, 45.8393), -- Location of the cell.
                heading = 1.5271, -- Direction to face the player upon spawn.
                size = 1.5, -- Size to check to see if any players are inside the cell.
            },
            {
                coords = vector3(1692.5017, 2442.8433, 45.8388), -- Location of the cell.
                heading = 359.2452, -- Direction to face the player upon spawn.
                size = 1.5, -- Size to check to see if any players are inside the cell.
            },
            {
                coords = vector3(1689.0546, 2442.6938, 45.8382), -- Location of the cell.
                heading = 1.9758, -- Direction to face the player upon spawn.
                size = 1.5, -- Size to check to see if any players are inside the cell.
            },
            {
                coords = vector3(1685.6172, 2442.7415, 45.8360), -- Location of the cell.
                heading = 0.3040, -- Direction to face the player upon spawn.
                size = 1.5, -- Size to check to see if any players are inside the cell.
            },
            {
                coords = vector3(1678.6830, 2443.0020, 45.8372), -- Location of the cell.
                heading = 3.1457, -- Direction to face the player upon spawn.
                size = 1.5, -- Size to check to see if any players are inside the cell.
            },
        },
        stores = {
            {
                ...
                coords = vector3(1779.0571, 2557.3472, 31.6925),
                heading = 173.8729,
                model = {hash = `s_m_y_chef_01`},
                catalog = {
                    {
