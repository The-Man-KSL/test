...
Config.crmtextui = true -- true = crm-textui (I recommend you using this since it is way more optimized than the default ShowHelpNotification) | false = ShowHelpNotification
...
Config.BankLocations = { -- to get blips and colors check this: https://wiki.gtanet.work/index.php?title=Blips
	...
	{blip = 108, blipColor = 3, blipScale = 0.9, x = 252.33, y = 218.11, z = 106.29, blipText = "Bank", BankDistance = 3},
	{blip = 108, blipColor = 2, blipScale = 0.7, x = 1175.064, y = 2706.643, z = 38.094, blipText = "Bank", BankDistance = 3},
	{blip = 108, blipColor = 2, blipScale = 0.7, x = 4476.9404, y = -4463.9307, z = 4.2601, blipText = "Bank", BankDistance = 3},
}
