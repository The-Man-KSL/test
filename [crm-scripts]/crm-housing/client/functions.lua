...
AddBlip = function(coords, sprite, colour, label, category, scale)
    ...
    SetBlipScale(blip, scale or (Config.Blips.Scale or 0.3))
...
Marker = function(position, text, control)
    DrawMarker(1, position - vec3(0.0, 0.0, 1.0), vec3(0.0, 0.0, 0.0), vec3(0.0, 0.0, 0.0), vec3(0.4, 0.4, 0.4), 0, 132, 255, 200)
