...
exports['crm-textui']:Open('[Key] Message', 'color', 'position')
...
To make the text bold: exports['crm-textui']:Open('<b>[Key] Message</b>', 'color', 'position')
To insert multiple lines/commands in a text UI: exports['crm-textui']:Open('[Key] Message 1<br>[Key] Message 2', 'color', 'position')

NOTE: 'color' and 'position' should be placed between ''

# To hide a text UI

exports['crm-textui']:Close()
	...
	while true do
		...
		if inZone and not shown then
			...
			if locked and hasAuth then
				exports['crm-textui']:Open('[E] Locked', 'lightred', 'left')
			elseif not locked and hasAuth then
				exports['crm-textui']:Open('[E] Unlocked', 'lightgreen', 'left')
			elseif locked then
				exports['crm-textui']:Open('Locked', 'lightred', 'left')
			else
				exports['crm-textui']:Open('Unlocked', 'lightgreen', 'left')
			end
