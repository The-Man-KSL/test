...
if Config.checkForUpdates then
    ...
    local resourceName = "crm-backpack"

    CreateThread(function()
        if GetCurrentResourceName() ~= "crm-backpack" then
            resourceName = "crm-backpack (" .. GetCurrentResourceName() .. ")"
        end
    end)

    CreateThread(function()
        while true do
            PerformHttpRequest("https://api.github.com/repos/wasabirobby/crm-backpack/releases/latest", CheckVersion, "GET")
            Wait(3600000)
        end
    end)
    ...
    GetRepoInformations = function()
        ...
        PerformHttpRequest("https://api.github.com/repos/wasabirobby/crm-backpack/releases/latest", function(err, response, headers)
            if err == 200 then
                ...
                repoURL = "https://github.com/wasabirobby/crm-backpack"
            end
        end, "GET")
