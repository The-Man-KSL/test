...
RegisterServerEvent('crm-backpack:openBackpack')
AddEventHandler('crm-backpack:openBackpack', function(identifier)
...
lib.callback.register('crm-backpack:getNewIdentifier', function(source, slot)
