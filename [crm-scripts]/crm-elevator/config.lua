...
Config.Elevators = {
	...
	ExampleElevator = {	
		{
			coords = vector3(943.1207, 48.6615, 80.2917), heading = 238.6146, level = "Floor 0", label = "Casino",
			jobs = {
				["unemployed"] = 0,
				["ambulance"] = 0,
				["police"] = 0,
		...
		{
			coords = vector3(979.9883, 49.0755, -1.8798), heading = 142.6787, level = "Floor 1", label = "Penthouses", 
			jobs = {
				["unemployed"] = 0,
				["ambulance"] = 0,
				["police"] = 0,
	...
	{
		coords = vector3(964.9379, 58.5981, 112.5530), heading = 64.3165, level = "Floor 2", label = "Roof", 
		jobs = {
			["unemployed"] = 0,
			["ambulance"] = 0,
			["police"] = 0,
