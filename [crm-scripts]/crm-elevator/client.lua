				...
				CreateThread(function()
					while true do
						...
						if distance <= 3.0 then
							sleep = 0
							DrawText3Ds(floor.coords.x,floor.coords.y,floor.coords.z, "Press ~b~E~w~ to use Elevator From " .. floor.level)
...
function NotifyNoAccess()
	AddTextEntry('elevatorHelp', 'You Require a Casino Membership')
	BeginTextCommandDisplayHelp('elevatorHelp')
	EndTextCommandDisplayHelp(0, false, true, -1)
end
