...
Config.useESXnotif = true -- use built-in ESX notifications -- only works with ESX !!
...
Config.giveFaceMenu = false -- Enables the Give Face Menu Button in the Player Options Menu ---> GiveFaceMenu()

Config.giveClothingMenu = false -- Enables the Give Clothing Menu Button in the Player Options Menu ---> GiveClothingMenu()

Config.respawnPlayer = true -- Enables the Respawn Button in the Player Options Menu ---> spawnSelector()

Config.openPlayerInventory = false -- Enables the Open Inventory Button in the Player Options Menu ---> OpenPlayerInv(id)
...
Config.KeyOpenMenu = 56 -- Key to open Admin Menu | 121 = INSERT KEY
...
--[[
		...
		our Discord Server and claim your roles: https://discord.gg/KxdPzC5EeJ
