...
AddEventHandler('onResourceStart', function(resource)
	if resource == GetCurrentResourceName() then
		...
		\_____|_|  \_\_|  |_|
							 ...
							 ^3
		CRM LS SEMI SERIOUS
		^1I N I T I A L I Z I N G
		Don't forget to read all the guides
		^4Server is ready to go!
		^5Thank you for buying this server!
		^6Visit: https://www.youtube.com/channel/UCjwERJWOEAWGmjpobtU6p_A for more!
		^7Help: https://discord.gg/devcrm for Support!
