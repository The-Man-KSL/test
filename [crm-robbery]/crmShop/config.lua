...
Config['ShopRobbery'] = {
    ...
    ['rewardItems'] = { -- Add this items to database or shared. Don't change the order, you can change the item names.
        ...
        {itemName = 'diamond', count = math.random(5, 10)},
        {itemName = 'container', count = math.random(1, 2)}, -- For safecrack reward
    },
    ['rewardMoneys'] = {
        ['safecrack'] = function()
...
Config['ShopRobberySetup'] = {
    ...
    [17] = {
        pedSetup = {model = 'mp_m_shopkeep_01', coords = vector3(4466.9595, -4463.5957, 3.2493), heading = 201.2210},
        safecrackSetup = {coords = vector3(4466.4541, -4459.8359, 3.2420), heading =  146.5206}, 
        lixeiroCharmoso = {marketId = "market_16", tillAmount = 1, remainingTill = 1}
    },
    [18] = {
        pedSetup = {model = 'csb_juanstrickler', coords = vector3(5012.0913, -5753.5591, 27.9001), heading = 59.2410},
        safecrackSetup = {coords = vector3(5005.4512, -5754.5093, 27.8453), heading =  163.4821}, 
        lixeiroCharmoso = {marketId = "market_16", tillAmount = 1, remainingTill = 1}
    },
}
