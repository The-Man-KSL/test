...
--[[         lockbox = function()
    ...
    grabReward = function() -- dont change this
        local rewards, random = {'cash', 'cash'}, math.random(1, 2)
        return rewards[random]
    end,
    trollyReward = function() -- dont change this
        local rewards, random = {'cash', 'cash', 'cash'}, math.random(1, 3)
        return rewards[random]
    end,
    finishHeist = {
...
Strings = {
    ['wait_nextheist'] = 'You have to wait this long to rob again',
    ['minute'] = 'minute.',
