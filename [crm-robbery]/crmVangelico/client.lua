...
AddEventHandler('vangelicoheist:client:policeAlert', function(targetCoords)
    ...
    TriggerServerEvent('cd_dispatch:AddNotification', {
        job_table = {'police'}, 
        coords = data.coords,
        title = '10-15 - Vangelico Store Robbery',
        message = 'A '..data.sex..' robbing the Vangelico Store at '..data.street, 
        flash = 1,
        ...
        blip = {
            ...
            colour = 3,
            flashes = true, 
            text = '911 - Vangelico Store Robbery',
            time = (5601000),
            sound = 3,
        }
    })
...
function Outside(index)
    lib.notify({
        title = 'CRM ROBBERY',
        description = 'Deliver the loot to the buyer, Marked on your map',
        type = 'success'
    })
    loadModel('baller')
    buyerBlip = addBlip(Config['VangelicoHeist']['finishHeist']['buyerPos'], 57, 0, Strings['buyer_blip'])
