            ...
            TriggerCallback('unionheist:server:checkTime', function(data)
                if data['status'] then
                    ...
                    lib.notify({
                        id = 'deliver3',
                        title = 'CRM RP',
                        description = 'Go to the marker on your GPS to get the cutter',
                        position = 'top',
                        style = {
                    ...
                    lib.notify({
                        id = 'deliver2',
                        title = 'CRM RP',
                        description = 'You will need Bags, C4 Bombs and cutters',
                        position = 'top',
                        style = {
                            backgroundColor = '#141517',
                            color = '#C1C2C5',
    ...
    TriggerCallback('unionheist:server:hasMoney', function(data)
        if data['status'] then
            ...
            lib.notify({
                id = 'deliver4',
                title = 'CRM RP',
                description = 'Cutter is now ready, check your GPS to start the Heist. Remember it is underground there are multiple ways in.',
                position = 'top',
                style = {
                    backgroundColor = '#141517',
                    color = '#C1C2C5',
...
function StartDrill()
    ...
    job_table = {'police'}, 
    coords = data.coords,
    title = '10-15 - Union Depository Robbery in progress.',
    message = 'A '..data.sex..' robbing the Union Depository '..data.street, 
    flash = 1,
...
function Outside()
    if robber then
        ...
        lib.notify({
            id = 'deliver1',
            title = 'CRM RP',
            description = 'Deliver to the buyer, Marked on your GPS',
            position = 'top',
            style = {
                backgroundColor = '#141517',
                color = '#C1C2C5',
        ...
        loadModel('baller')
        buyerBlip = addBlip(Config['UnionHeist']['finishHeist']['buyerPos'], 57, 0, Strings['buyer_blip'])
