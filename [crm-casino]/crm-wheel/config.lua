...
Config.Prices = {
	...
	[3]  = {type = 'item', 		name = 'casinochips', 		count = 2000, 		sound = 'clothes', 	probability = {a =   5, b =  10}},	--  0.5 %   1.0 -- CLOTHING
	...
	[7]  = {type = 'item', 		name = 'casinochips', 		count = 150, 	sound = 'clothes', 	probability = {a =  60, b =  80}},	--  4.0 %   8.0 -- CLOTHING
	[8]  = {type = 'item', 	name = 'weapon_pistol', count = 1, 		sound = 'mystery', 	probability = {a =  80, b = 120}},	--  4.0 %  12.0 -- MYSTERY
	...
	[18] = {type = 'item', 		name = 'casinochips', 	count = 30000, 		sound = 'win', 		probability = {a = 720, b = 810}},	--  9.0 %  81.0 -- 2.500 RP
	[19] = {type = 'item', 		name = 'casinochips', 	count = 100000, 		sound = 'clothes', 	probability = {a = 810, b = 900}},	--  9.0 %  90.0 -- CLOTHING
